...
addon.Cooldowns = {
    ...
    [106951]    = { class = "DRUID", duration = 180, specID = { 103, 104, }, },                 -- Berserk (Cat Form)
    ...
    [1499]      = { duration = { default = 30, [255] = 24, }, class = "HUNTER" },               -- Freezing Trap
        [60192]     = { parent = 1499, },                                                       -- Freezing Trap (Trap Launcher)
    [13813]     = { duration = { default = 30, [255] = 24, }, class = "HUNTER" },               -- Explosive Trap
        [82939]     = { parent = 13813, },                                                      -- Explosive Trap (Trap Launcher)
    [13809]      = { duration = { default = 30, [255] = 24, }, class = "HUNTER" },              -- Ice Trap
        [82941]     = { parent = 13809, },                                                      -- Ice Trap (Trap Launcher)
    [34600]     = { duration = { default = 30, [255] = 24, }, class = "HUNTER" },               -- Snake Trap
    ...
    [6552]          = { default = true, duration = 15, class = "WARRIOR" },                     -- Pummel
        [102060]        = { parent = 6552, duration = 40, class = "WARRIOR" },                  -- Disrupting Shout
