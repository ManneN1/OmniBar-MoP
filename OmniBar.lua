...
local WOW_PROJECT_CLASSIC = 2 -- hackfix for MoP
local WOW_PROJECT_ID = 1 -- hackfix for MoP
local WOW_PROJECT_MAINLINE = 1 -- hackfix for MoP
local bit_band = bit.band
local tinsert = tinsert
local wipe = wipe

OmniBar = LibStub("AceAddon-3.0"):NewAddon("OmniBar", "AceEvent-3.0", "AceTimer-3.0")
